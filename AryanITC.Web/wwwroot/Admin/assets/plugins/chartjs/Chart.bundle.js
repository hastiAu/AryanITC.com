...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		getRuler: function(index) {
			...
			var Categoriespacing = (tickWidth - (tickWidth * xScale.options.categoryPercentage)) / 2;
			...
			return {
				...
				Categoriespacing: Categoriespacing,
		...
		calculateBarX: function(index, datasetIndex) {
			...
			if (xScale.options.stacked) {
				return leftTick + (ruler.categoryWidth / 2) + ruler.Categoriespacing;
			}

			return leftTick +
				(ruler.barWidth / 2) +
				ruler.Categoriespacing +
	...
	Chart.controllers.horizontalBar = Chart.controllers.bar.extend({
		...
		getRuler: function (index) {
			...
			var Categoriespacing = (tickHeight - (tickHeight * yScale.options.categoryPercentage)) / 2;
		...
		calculateBarY: function (index, datasetIndex) {
			...
			if (yScale.options.stacked) {
				return topTick + (ruler.categoryHeight / 2) + ruler.Categoriespacing;
			}
